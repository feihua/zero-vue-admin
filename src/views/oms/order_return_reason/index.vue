...
<script>
  import { createOrderReturnReason, deleteOrderReturnReason, queryOrderReturnReasonList, updateOrderReturnReason } from '@/api/oms/order_return_reason'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryOrderReturnReasonList(this.listQuery).then(response => {
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            createOrderReturnReason(this.temp).then(() => {
              this.getList()
      ...
      updateData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            updateOrderReturnReason(tempData).then(() => {
      ...
      handleDelete(row) {
        this.$confirm('此操作将永久删除该条数据, 是否继续?', '提示', {
          ...
          deleteOrderReturnReason(row.id).then(response => {
            this.getList()
            this.$message({
              type: 'success',
              message: '删除成功!'
