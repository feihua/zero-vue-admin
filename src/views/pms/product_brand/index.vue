...
<script>
  import { createProductBrand, deleteProductBrand, queryProductBrandList, updateProductBrand } from '@/api/pms/product_brand'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryProductBrandList(this.listQuery).then(response => {
      ...
      updateData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            ...
            updateProductBrand(tempData).then(() => {
