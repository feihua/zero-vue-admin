...
<script>
  import { createCoupon, deleteCoupon, queryCouponList, updateCoupon } from '@/api/sms/coupon'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryCouponList(this.listQuery).then(response => {
