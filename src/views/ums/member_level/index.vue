...
<script>
  import { createMemberLevel, deleteMemberLevel, queryMemberLevelList, updateMemberLevel } from '@/api/ums/member_level/index'
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        queryMemberLevelList(this.listQuery).then(response => {
